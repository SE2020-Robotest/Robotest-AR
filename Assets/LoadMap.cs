    ...
    public class LoadMap : MonoBehaviour
    {
        public void loadMap(Map request)
        {
            ...
            for (int i = 0; i < 4; i++)
            {
                ...
                wallList[i].transform.parent = this.transform;
            }
            ...
            foreach (Block block in blocks)
            {
                ...
                if (type == Block.Types.Type.Cube)
                {
                    ...
                    obstacles.transform.parent = this.transform;
					obstacles.transform.localScale = new Vector3((float)(block.W/10.0),5,(float)(block.H/10.0));
					//obstacles.transform.position = new Vector3((float)(block.X/10.0),2.5,(float)(block.Y/10.0));
                }
